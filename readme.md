...
## Решение
Номер задачи можно изменить, задав значение переменной `TIMUS_CURRENT_TASK` в CMakeLists.txt  
Для проверки на тимусе нужно скопировать в тимус содержимое файла с соответствующей задачей, 
